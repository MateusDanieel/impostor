export const categories = [
    ...
    },
    {
        id: "dops",
        label: "Dopster",
        words: ["Fernanda", "Felipe", "Sâmya", "Agide", "Kauan", "Gabs", "Greg", "Jeong", "Marco", "Leo", "Amanda", "Mateus", "Guilherme", "Leoni", "Lucas", "Melanie", "Sergio", "Zé", "Welton", "Meroni", "Mari", "Murilo", "Buzz Lighyear", "Among Us", "Cordenas", "pip install p", "Mata Rato", "Luke", "Miqueias", "Troféu Silvio Santos Peladinho", "Efraim", "Ricardo", "Vampeta", "Luiz"]
    }
]